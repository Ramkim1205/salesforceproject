...
import LATITUDE_FIELD from '@salesforce/schema/Opportunity.Latitude__c';
import LONGITUDE_FIELD from '@salesforce/schema/Opportunity.Longitude__c';
import ADDRESS_FIELD from '@salesforce/schema/Opportunity.Address__c';
import DISTRICT_FIELD from '@salesforce/schema/Opportunity.District__c';

export default class OpportunityLocationMap extends LightningElement {
    @api recordId;
    @track latitude;
    @track longitude;
    @track address;
    ...
    wiredOpportunity({ error, data }) {
        if (data) {
            console.log('✅ 기회 데이터 가져오기 성공:', data);
            ...
            console.error('❌ 기회 데이터 가져오기 실패:', error);
        }
    }
